    ...
    >
      <div className={`${styles.wrapperObjetivos} container my-5`} >
        ...
        <table className="table">
          <thead className="table-info text-center align-middle">
            <tr>
          ...
          <tbody>
            ...
            <tr className="table align-middle">
              <td className='fw-bold'>
                2. GESTIÓN ACADÉMICA Y PROGRAMAS DE ESTUDIO PERTINENTES Y ALINEADOS A LAS NORMAS DEL MINEDU.	
              </td>
              <td>
                OE5: Diseñar y ejecutar el Plan de autoevaluación que permita mejorar los sistemas de organización y evaluación para lograr la acreditación de los Programas de estudio que el IESTP “Florencia de Mora” oferta.	
              </td>
              <td>
                <p>
            ...
            <tr className="table align-middle">
              <td className='fw-bold'>
                3. INFRAESTRUCTURA FÍSICA, EQUIPAMIENTO Y RECURSOS PARA EL APRENDIZAJE
              </td>
            ...
            <tr className="table align-middle">
              <td className='fw-bold'>
                4. PERSONAL DIRECTIVO, JERÁRQUICO Y DOCENTE
              </td>
              <td>
                OE4: Mejorar de manera autónoma sus capacidades profesionales a través de la reflexión sistemática de su experiencia docente, participando en actividades formativas que garanticen su actualización profesional permanente y que evidencie una ética sostenible con los estudiantes y con el desarrollo sostenible del país.
              </td>
              <td>
                <p>
            ...
            <tr className="table align-middle">
              <td className='fw-bold'>
                5. PREVISIÓN ECONÓMICA Y FINANCIERA
              </td>
              <td>
                OE3: Incrementar la capacidad financiera del IESTP “Florencia de Mora” mediante la Gestión de Proyectos institucionales y la realización de actividades productivas
              </td>
              <td>
                <p>
